...
export default function First({set, data, fake}) {
    const elements = [
        ...
        { id: 7, name: "학습자료실", x: 54, y: 13, width: 3, height: 6 },
        ...
        { id: 32, name: "소프트웨어 공학실", x: 39.2, y: 80.5, width: 5.5, height: 7.5 },
        { id: 33, name: "데이터 네트워크실", x: 44.7, y: 80.5, width: 5.5, height: 7.5 },
