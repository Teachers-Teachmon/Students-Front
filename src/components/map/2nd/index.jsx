...
export default function Second({set, data, fake}) {
    const elements = [
        ...
        { id: 8, name: "학습자료실", x: 54, y: 13, width: 3, height: 6},
        ...
        { id: 13, name: "크리에이티브존", x: 79, y: 10.5, width: 9, height: 5},
        ...
        { id: 31, name: "임베디드 소프트웨어개발과 연구실", x: 12, y: 62.5, width: 4, height: 5},
        { id: 32, name: "계단", x: 12, y: 67.5, width: 4, height: 3},
        { id: 33, name: "계단", x: 12, y: 43, width: 4, height: 3},
        { id: 34, name: "IOT 자동제어실", x: 18, y: 46.5, width: 5, height: 8},
        { id: 35, name: "마이크로 프로세서실", x: 18, y: 54.5, width: 5, height: 8},
        { id: 36, name: "임베디드 시스템실", x: 18, y: 62.5, width: 5, height: 8},
