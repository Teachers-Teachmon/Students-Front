...
export default function Second({set, data}) {
    const elements = [
        ...
        { id: 31, name: "X", x: 30, y: 77.5, width: 23, height: 10.5, backgroundColor: "#DDDDDD", cursor: "pointer" },
        { id: 36, name: "BSSM GYM", x: 150, y: 390, width: 50, height: 120, backgroundColor: "#DDDDDD", cursor: "pointer" },
        { id: 37, name: "임베디드 소프트웨어개발과 연구실", x: 150, y: 500, width: 50, height: 6, backgroundColor: "#DDDDDD", cursor: "pointer" },
